        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Text('Unite', style: TextStyle(fontSize: 48, fontWeight: FontWeight.bold, color: Colors.black87)),
                const SizedBox(height: 16),
                const Text('Find, Create, Celebrate', style: TextStyle(fontSize: 20, color: Colors.black54)),
